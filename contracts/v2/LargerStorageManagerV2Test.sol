...
contract LargeStorageManagerV2Test is LargeStorageManagerV2 {
    ...
    function getChunk(bytes32 key, uint256 chunkId) public view returns (bytes memory, bool) {
    ...
    function chunkSize(bytes32 key, uint256 chunkId) public view returns (uint256, bool) {
    ...
    function stakeTokens(bytes32 key, uint256 chunkId) public view returns (uint256) {
        return _stakeTokens(key, chunkId);
    }

    function chunkStakeTokens(bytes32 key, uint256 chunkId) public view returns (uint256, bool) {
        return _chunkStakeTokens(key, chunkId);
    }

    function getChunkAddr(bytes32 key, uint256 chunkId) public view returns (address) {
